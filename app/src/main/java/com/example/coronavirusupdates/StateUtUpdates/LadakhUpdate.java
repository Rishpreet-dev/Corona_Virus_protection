...
public class LadakhUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(Html.fromHtml("Ladakh: Restrictions on air services <br><font color=\"blue\">2020-03-31</font>"));
        arrayList.add(Html.fromHtml("Ladakh: Notification for UTwide lockdown <br><font color=\"blue\">2020-03-31</font>"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String url="", title = "";
                if(position==1) {
                    url = "https://static.mygov.in/rest/s3fs-public/mygov_158505769251307401.pdf";
                    title = "mygov_158505769251307401.pdf";
                }
                if(position==2) {
                    url = "https://static.mygov.in/rest/s3fs-public/mygov_158511569751307401.pdf";
                    title = "mygov_158511569751307401.pdf";
                }
