...
public class AndhraPradeshUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(Html.fromHtml("Andhra Pradesh: Instructions in order to prevent COVID-19 (Corona Virus) in the State <br><font color=\"blue\">2020-04-04</font>"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String url="", title = "";
                if(position==1) {
                    url = "https://static.mygov.in/rest/s3fs-public/mygov_158504639951307401.pdf";
                    title = "mygov_158504639951307401.pdf";
                }
                try {
