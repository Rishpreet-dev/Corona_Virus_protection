...
public class BiharUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(Html.fromHtml("Bihar: Notification for statewide lockdown <br><font color=\"blue\">2020-03-31</font>"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String url="", title = "";
                if(position==1) {
                    url = "https://static.mygov.in/rest/s3fs-public/mygov_158505195751307401.pdf";
                    title = "mygov_158505195751307401.pdf";
                }
                try {
