...
public class WestBengalUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(Html.fromHtml("West Bengal: Notification for lockdown in 23 areas <br><font color=\"blue\">2020-03-27</font>"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String url="", title = "";
                if(position==1) {
                    url = "https://static.mygov.in/rest/s3fs-public/mygov_158511551351307401.pdf";
                    title = "mygov_158511551351307401.pdf";
                }
                try {
